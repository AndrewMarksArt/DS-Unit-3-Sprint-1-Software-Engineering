...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  Answer: Important aspects of code reviews to me is to make sure it meets all 
  requirements, that there are no unintended side effects, its consistent and 
  easy to understand/read. Sometimes I miss things so making sure all requirements
  are meet, that it wont break any existing code unintentionally, and that it meets
  the standards for style so that in the future when someone else is looking at it
  they can read it and it is consistent with all other code. I also appreciate when 
  I get feedback that something could have been done differently or more efficiently
  since this is a great way to learn.
  
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  
  Answer: Containers give us predictable and consistent environments to help avoid
  the 'it works on my machine' issue. Containers can contain the appropriate versions
  of libraries and other dependencies to make sure no matter who is running our code
  it will work. An good example might be if we had an older project using Python 2.7 
  and personally I'm using Python 3 without a virtual environment or using containers
  there would be issues. If we are using containers it could contain Python 2.7 creating
  a virtual environment with the correct Python version so that I wouldn't have to make
  changes to my local machine. 
